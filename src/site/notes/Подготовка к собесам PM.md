...
- Заказчики: Отели, Клиники, Салоны красоты, Консалтинговые и маркетинговые компании, интернет-магазины одежды.
...
Я работаю IT Product Manager с 6+ годами опыта, специализируюсь на B2B и SaaS-продуктах. Мой стек: Agile/Scrum, JTBD, A/B тестирование, SQL, Python для анализа данных.
