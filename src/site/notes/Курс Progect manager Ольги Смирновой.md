---
{"dg-publish":true,"permalink":"/kurs-progect-manager-olgi-smirnovoj/"}
---
...
- Сбор требований на интервью (CustDev) и занесение в "документ БТ", составление матрицы трассировки требований, прохождение HADI-циклы, приоритезация Бэклога с User story (MoSCoW), выявление критерий готовности DoD и DoR, оценка трудоёмкости (Storepoint), внесение изменений (Grooming).
