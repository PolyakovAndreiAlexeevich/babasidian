...
![Pasted image 20251017165859.png](/img/user/Pasted%20image%2020251017165859.png)

Критический путь — **самый длинный путь в сетевой диаграмме за самое короткое время**

Веха отмечается, как задача с нулевой продолжительность (выглядит, как ромб) — это ключевые чекпоинты проекта.
